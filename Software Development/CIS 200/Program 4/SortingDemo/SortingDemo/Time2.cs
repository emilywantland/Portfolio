// Modified by: Andrew L. Wright
// Now supports natural order
...
public class Time2 : IComparable<Time2>
{
    ...
    public int CompareTo(Time2 t2)
    {
        ...
        if (this.Hour.CompareTo(t2.Hour) != 0)          // Different hours?
            return this.Hour.CompareTo(t2.Hour);        // Use Hour to decide
        else if (this.Minute.CompareTo(t2.Minute) != 0) // Different minutes?
            return this.Minute.CompareTo(t2.Minute);    // Use Minute to decide
        else                                            // Down to seconds
            return this.Second.CompareTo(t2.Second);    // Use Second to decide
    }
