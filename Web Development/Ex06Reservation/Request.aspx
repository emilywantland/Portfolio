        ...
        <main>
            <form id="form1" runat="server" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <!-- drop-down -->
                        <asp:DropDownList ID="dropDownNumberOfPeople" runat="server" CssClass="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="bedtype">
                        <!-- radio buttons -->
                        <input id ="radio1King" name="radio" type="radio" checked="checked" /><label>King</label>
                        <input id ="radio2Queen" name="radio" type="radio" /><label>Two Queens</label>
                        <input id ="radio1Queen" name="radio" type="radio" /><label>One Queen</label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-7">
                        <!-- multiline text box -->
                        <asp:TextBox ID="txtSpecialRequests" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="4"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <!-- drop down -->
                        <asp:DropDownList ID="dropDownPreferredMethod" runat="server" CssClass="form-control">
